...
class Page8(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		def makeUser():
			...
			dbLink.updatePhone(User_first_name,User_last_name,User_phone)
			
			name_first.delete(0,last=tk.END)
			name_last.delete(0,last=tk.END)
			phone_num.delete(0,last=tk.END)
		...
		self.configure(bg="#000000")
		self.button1 = ImageTk.PhotoImage(Image.open("images/greybutton.png"))
		label = tk.Label(self, anchor="center",text="Please enter your information" ,bd=0,bg="#000000",fg="#ffffff",highlightthickness=0,justify=tk.CENTER,pady=25,wraplength=100)
		...
		last_label = tk.Label(self, anchor=tk.W,text="Last",bd=0,bg="#000000",fg="#ffffff",highlightthickness=0)
		last_label.grid(row=1,column=2)
		
		userLastEntered = tk.StringVar()
		name_last = tk.Entry(self,justify=tk.LEFT,textvariable=userLastEntered)
		name_last.grid(row=2,column=2)
		
		phone_label = tk.Label(self, anchor=tk.W,text="Ph#(no spaces)",bd=0,bg="#000000",fg="#ffffff",highlightthickness=0)
		phone_label.grid(row=1,column=3)
		
		userPhoneEntered = tk.StringVar()
		phone_num = tk.Entry(self,justify=tk.LEFT,textvariable=userPhoneEntered)
		phone_num.grid(row=2,column=3)
		
		dob_label = tk.Label(self, anchor="w",text="Birth Date:",bd=0,bg="#000000",fg="#ffffff",highlightthickness=0)
		dob_label.grid(row=4,column=0,sticky=tk.E)
		
		#DOB month info
		mon_label = tk.Label(self, anchor="center",text="mm",bd=0,bg="#000000",fg="#ffffff",highlightthickness=0)
		mon_label.grid(row=3,column=1,sticky=tk.S)
		...
		day_label.grid(row=3,column=2,sticky=tk.S)
		...
		yr_label.grid(row=3,column=3,sticky=tk.S)
...
class Page9(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		first_label = tk.Label(self, anchor=tk.W,text="First",bd=0,bg="#000000",fg="#ffffff",highlightthickness=0)
		first_label.grid(row=1,column=1,sticky=tk.W)
		...
		last_label.grid(row=1,column=3,sticky=tk.W)
